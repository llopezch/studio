...
const banksData = [
  { name: 'Interbank', buy: 3.510, sell: 3.605, buyChange: -0.019, sellChange: -0.005, date: '15/01/24 14:30', logoUrl: 'https://www.interbank.pe/themes/custom/portalinterbank/logo.svg' },
  { name: 'BCP', buy: 3.505, sell: 3.610, buyChange: -0.017, sellChange: 0.002, date: '15/01/24 14:25', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/6/6a/Logo_del_Banco_de_Cr%C3%A9dito_del_Per%C3%BA.svg' },
  { name: 'BBVA', buy: 3.508, sell: 3.608, buyChange: 0.002, sellChange: 0.001, date: '15/01/24 14:35', logoUrl: 'https://upload.wikimedia.org/wikipedia/commons/0/05/BBVA_2019.svg' },
  { name: 'Scotiabank', buy: 3.512, sell: 3.612, buyChange: 0.008, sellChange: -0.004, date: '15/01/24 14:20', logoUrl: 'https://www.scotiabank.com/content/dam/scotiabank/global/logos/logo-scotiabank.svg' },
  { name: 'Banco de la Nación', buy: 3.515, sell: 3.615, buyChange: -0.010, sellChange: -0.013, date: '15/01/24 14:28', logoUrl: 'https://www.bn.com.pe/images/logo-bn.png' },
];
