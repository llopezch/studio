...
const banksData = [
  { name: 'Interbank', buy: 3.510, sell: 3.605, buyChange: -0.019, sellChange: -0.005, date: '15/01/24 14:30', logoUrl: '/logos/interbank.svg' },
  { name: 'BCP', buy: 3.505, sell: 3.610, buyChange: -0.017, sellChange: 0.002, date: '15/01/24 14:25', logoUrl: '/logos/bcp.svg' },
  { name: 'BBVA', buy: 3.508, sell: 3.608, buyChange: 0.002, sellChange: 0.001, date: '15/01/24 14:35', logoUrl: '/logos/bbva.svg' },
  { name: 'Scotiabank', buy: 3.512, sell: 3.612, buyChange: 0.008, sellChange: -0.004, date: '15/01/24 14:20', logoUrl: '/logos/scotiabank.svg' },
  { name: 'Banco de la Nación', buy: 3.515, sell: 3.615, buyChange: -0.010, sellChange: -0.013, date: '15/01/24 14:28', logoUrl: '/logos/banco-nacion.svg' },
];
