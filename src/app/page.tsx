    ...
    <div className="bg-background text-foreground min-h-screen w-full">
      ...
      <div className="container mx-auto p-4 sm:p-6 lg:p-8">
        <main className="space-y-8">
          ...
          <section>
            <h2 className="text-lg font-bold mb-4 font-headline">Tipos de Cambio por Banco</h2>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            <div className="lg:col-span-2">
              <h2 className="text-lg font-bold mb-4 font-headline">Evolución del Tipo de Cambio (USD a PEN)</h2>
              <Card>
            ...
            <div>
              <h2 className="text-lg font-bold mb-4 font-headline">Tipo de Cambio - SUNAT</h2>
              <Card>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <div className="lg:col-span-2">
              <Card>
                  <CardHeader>
                    <CardTitle className="font-headline text-lg">Histórico PEN/USD</CardTitle>
                    <CardDescription>
